                                    ...
                                    <div className="row" data-aos="fade-up">
                                        <div className="col-lg-12 d-flex justify-content-center">
                                            <ul id="portfolio-flters">
                                                <li data-filter=".filter" className="filter-active" style={{display:"block"}}>Common credentials</li>
                                               
                                                <span style={{display:"block"}}><span className="fw-bold">User</span> : midhunkumarengineer98@gmail.com || <span>Password : 12345678</span></span>
                                                
                                                <span><span className="fw-bold" style={{display:"inline"}}>Admin</span> : midhunkumar71371@gmail.com || <span> Password : admin123</span></span>
                                            </ul>
                                        </div>
                                    </div>
