    ...
    return (
        ...
        <div className="card-title fs-5 col-lg-7 col-sm-12">If you want to know more about me or my work,or if you would just like to say hello,send me a message.I'd love to hear from you</div>
          ...
          <div className=" card col-lg-6 mt-2 pt-2 pb-3">
            <form action="mailto:midhunkumarengineer98@gmail.com" method="post" encType='text/plain' >
            <div className="row">
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <input name="mail" type="email" className="form-control" id="exampleFormControlInput1" placeholder="Enter your email"/>
              </div>
              <div className="mb-3">
                <label for="exampleFormControlTextarea1" className="form-label fs-4 fw-normal fst-italic" >Message</label>
                <textarea name="Purpose" type="text" className="form-control" id="exampleFormControlTextarea1" rows="5"></textarea>
              </div>
              <div className="">
              <div className="d-grid gap-2 d-md-flex justify-content-md-end mt-3 ">
                <button className="btn btn-outline-danger me-md-2" type="submit" value="Send">Send message</button>
              </div>
            </div>
          </div>
          </form>
        ...
        <div className="col-lg-6">
          <div className="row">
            ...
            <div className="fs-4 fw-normal fst-italic d-flex justify-content-lg-end">
              ...
              <a class="btn text-white mx-2" style={{backgroundColor: "#333333"}} href="https://github.com/midhun786" target="_blank" role="button"><i class="fab fa-github"></i></a>
              <a class="btn text-white mx-2" style={{backgroundColor: "#c61118"}} href="https://mail.google.com/mail/u/0/?hl=en-GB&tf=cm&fs=1&to=midhunkumarengineer98@gmail.com" target="_blank" role="button"><i class="fas fa-envelope"></i></a>
